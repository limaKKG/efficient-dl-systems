...
def main():
    ...
    s3.download_file('rnd-customer-service-platform-ml-data', 'wikitext-103-raw-v1/train-00000-of-00002.txt', 'train-00000-of-00002.txt')
    s3.download_file('rnd-customer-service-platform-ml-data', 'wikitext-103-raw-v1/train-00001-of-00002.txt', 'train-00001-of-00002.txt')
    BATCH_SIZE = 8
    K_LIST = [1, 5, 10, 20, 50]
